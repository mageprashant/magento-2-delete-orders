...
use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection as OrderDelete;
...
use MagePrashant\DeleteOrder\Helper\Data as DataHelper;
...
class Delete extends AbstractMassAction
{
    ...
    protected function massAction(OrderDelete $collection)
    {
